...
async function main() {
    ...
    // ============================================
    // CONSULTORIOS CONFIGURACIÓN (Categoría I-4)
    // ============================================
    const consultorioConfigs = [
    ...
    for (const config of consultorioConfigs) {
        await prisma.consultorioConfig.upsert({
    ...
    console.log('✅ ConsultorioConfigs created');
